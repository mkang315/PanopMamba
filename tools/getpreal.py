...
for file in glob.glob("./outputs_txt/real/*.png"):
    ...
    h,w,c  = img.shape
    with open(os.path.join("./txtoutputs/real",f"{name}.txt"),"w") as f:
        ...
        cv2.imwrite(os.path.join("./outputs_txt/real",f"{name}_.png"),output_image)
