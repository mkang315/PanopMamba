...
## Model
Our model is built on [MMSegmentation)](https://github.com/open-mmlab/mmsegmentation) v1.2.2 (released on 14 Dec 2023). The model configuration file is in the folder .\configs\panopmamba. The pretrained [MSVMamba-Tiny checkpiont](https://drive.google.com/drive/folders/1ddNWk89ohcxxMuVEaJ2Y5A6xeBKgA7lU?usp=drive_link) is provided in [MSVMamba](https://github.com/YuHengsss/MSVMamba).
